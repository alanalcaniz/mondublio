        ...
        <div class="container d-flex flex-column justify-content-center align-items-center min-vh-100">
            <div class="card shadow p-4 w-100" style="max-width: 400px;">
                ...
                <% 
                    ...
                    if (max < min) {
                        out.print("<div class='alert alert-danger text-center'><h2>Error: El valor máximo es mayor que el valor mínimo</h2></div>");
                    }else {
                ...
                <a href="formulario.html" class="btn btn-primary w-100">Volver al formulario</a>
